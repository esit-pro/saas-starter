 ...
 */
async function migrateComments(ticketMap: Record<number, number>, userIds: { janeId: number, johnId: number }) {
 ...
 */
async function migrateExpenses(clientMap: Record<number, number>, ticketMap: Record<number, number>, userIds: { janeId: number, johnId: number }) {
